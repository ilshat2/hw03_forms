...
# Список адресов директорий статических файлов, может быть так же кортежем:
...
EMAIL_FILE_PATH = os.path.join(BASE_DIR, 'sent_emails')  # директория, в которую будут складываться файлы писем
